...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> getRecipes() async {
    try {
      const url =
          "https://api.edamam.com/search?q=vegetable&app_id=ebb6041c&app_key=3c33ad913ab23b8554082bfb5fdd78b5";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                            ...
                            Positioned(
                              ...
                              child: IconButton(
                                icon: Icon(
                                  Icons.favorite,
                                  color: Colors
                                      .red.shade500, // Set the color to red
                                ),
                                onPressed: () {
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        currentIndex: 0,
        // Initially selected index (e.g., Home page)
        onTap: (int index) {
          switch (index) {
            case 0:
